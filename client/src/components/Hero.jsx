...
const Hero = () => {
    ...
    const onSearch = async (e) => {
        ...
        try {
            // Save recent searched city for user
            ...
            if (token) {
                ...
                // Update local searchedCities (max 3 recent searches)
    ...
    return (
        ...
        >
            ...
            <p className='max-w-130 mt-2 text-sm md:text-base'>
                Book luxury stays, best prices, and unforgettable experiences at top destinations worldwide.
            </p>
