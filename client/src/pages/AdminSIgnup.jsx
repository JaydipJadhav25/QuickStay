...
const AdminSIgnup = () => {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Admin</h2>
      ...
      <p className="text-center mt-4">
        Already have an account? <a href="/adminlogin" className="text-blue-500 underline">Log In</a>
      </p>
