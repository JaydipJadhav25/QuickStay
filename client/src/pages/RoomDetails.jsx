...
import { assets, facilityIcons, roomCommonData, roomsDummyData } from '../asset/assets';
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col lg:flex-row mt-6 gap-6'>
        <div className='lg:w-1/2 w-full'>
          <img src={mainImage} alt="Room Image" srcset="" className='w-full rounded-xl shadow-lg object-cover' />
        </div>
        <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
          {room?.images.length > 1 && room.images.map((image, index) => (
            <img onClick={() => setMainImage(image)}
              src={image} alt="Room Image" srcset="" key={index}
          ...
          <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
            {room.amenities.map((item, index) => (
              <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-100'>
                <img src={facilityIcons[item]} alt={item} srcset=""
                  className='w-5 h-5' />
      ...
      <form className='flex flex-col md:flex-row items-start md:items-center
        ...
        <div className='flex flex-col flex-wrap md:flex-row items-start 
          ...
          <div className='flex flex-col'>
            ...
            <input type="date" name="" id="checkInDate" placeholder='Check-In' className='
          ...
          <div className='flex flex-col'>
            ...
            <input type="date" name="" id="checkOutDate" placeholder='Check-Out' className='
              w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
          </div>
          ...
          <div className='flex flex-col'>
            ...
            <input type="number" name="" id="guests" placeholder='0' className='
      ...
      <div className='mt-25 space-y-4'>
        {roomCommonData.map((spec, index) => (
          <div key={index} className='flex items-start gap-2'>
            <img src={spec.icon} alt={`${spec.title}-icon`} className='w-6.5' srcset="" />
            <div>
      ...
      <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
          ...
          className='h-14 w-14 md:h-18 md:W-18 rounded-full' srcset="" />
          <div>
        ...
        <button className='px-6 py-2.5 rounded text-white bg-primary
